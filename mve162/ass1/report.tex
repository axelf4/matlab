...
% Question 3 & 5.
Hittils är det totala antalet rapportede infekterade 20302 stycken,
...
\section{Andra modellen}

\begin{equation}\label{eq:ssirr}
	\begin{alignedat}{4}
		& \frac{dS_1}{dt} &=& &-r_1&SI && \\
		& \frac{dS_2}{dt} &=& &-r_2&SI && \\
		& \frac{dI}{dt} &=& &(r_1 + r_2)&SI &-\gamma& I \\
...
\begin{figure}
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{Åldersdistributionen i Sverige år 2019. \autocite{populationDist}}
\end{figure}
